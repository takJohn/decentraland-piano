...
Download and install the Decentraland CLI by running the following command. Please read the [installation guide](https://docs.decentraland.org/getting-started/installation-guide/) for further details.
